...
urlpatterns = patterns('',
        ...
        (r'main/mood/(?P<age_band>.+)/(?P<gender>.+)/(?P<race>.+)/(?P<mood>.+)/(?P<date_from>.*)/(?P<date_to>.*)/', 'main.views.mood_ajax'),
        (r'main/profile/(?P<age_band>.+)/(?P<gender>.+)/(?P<race>.+)/(?P<mood>.+)/(?P<date_from>.*)/(?P<date_to>.*)/(?P<dimension>.+)/', 'main.views.profile_ajax'),
        (r'main/trend/(?P<age_band>.+)/(?P<gender>.+)/(?P<race>.+)/(?P<mood>.+)/(?P<date_from>.*)/(?P<date_to>.*)/', 'main.views.trend_ajax'),
        (r'main/wday/(?P<age_band>.+)/(?P<gender>.+)/(?P<race>.+)/(?P<mood>.+)/(?P<date_from>.*)/(?P<date_to>.*)/', 'main.views.wday_ajax'),                                
